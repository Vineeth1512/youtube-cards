...
//console.log(videoCardWrapper);
function Youtube() {
    
var videoCardWrapper = document.getElementById("video-card-wrapper")
return videos.map((video, i) => {

    videoCardWrapper.innerHTML += `<div class="video-card">
    ...
    <div class="channel-likes-wrapper">
        ...
        <p>${video.views} views <span>${video.likes} likes</span></p>
    </div>`
    })
